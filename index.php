      ...
      <div class="container">
        <div class="row">
          <div class="intro-text">
            ...
            <a href="#services" class="btn btn-default btn-lg page-scroll">Let's Explore More</a> </div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="categories">
      <ul class="cat">
        <li>
          <ol class="type">
            <li>
              <form method="get" action="registerUser.html">
                <button type="submit" class="btn btn-default">Register As User</button>
              </form>
            </li>
            <li>
              <form method="get" action="registerDriver.html">
