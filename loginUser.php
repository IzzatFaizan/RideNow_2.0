...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="index.html"><i class="fa fa-car"></i> RideNow</a> 
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="index.html" class="page-scroll">Register</a></li>
        <li><a href="index.html" class="page-scroll">Contact</a></li>
        <li><a href="#" class="page-scroll fa fa-car"> Login</a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
